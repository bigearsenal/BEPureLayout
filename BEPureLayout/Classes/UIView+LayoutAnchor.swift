...
public extension UIView {
    ...
    func activate(anchors: [BELayoutAnchor], relativeTo item: UIView? = nil) {
...
extension NSLayoutConstraint {
    convenience init(from: UIView, to item: UIView?, anchor: BELayoutAnchor) {
        switch anchor {
