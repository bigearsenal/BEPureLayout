...
class ContentHuggingScrollVC: BEViewController {
    ...
    func setUpStackView(_ stackView: UIStackView) {
        stackView.addArrangedSubviews {
            UILabel(text: text, textSize: 15, textColor: .black, numberOfLines: 0)
            UIButton(backgroundColor: .red, cornerRadius: 10, label: "This is a button", textColor: .white, contentInsets: UIEdgeInsets(top: 10, left: 10, bottom: 10, right: 10))
            UIImageView(height: 200, cornerRadius: 20, imageNamed: "dogs")
        }
    }
